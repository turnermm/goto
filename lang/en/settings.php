...
$lang['auto_options'] = 'Target for the auto_login page. In each case <b>user</b> refers to the user\'s ' .
         ' login name.  If the login name is "foo", then ":user_page" is "foo" in the root namespace; '  .
		 ' "user_ns:user_page" is ":foo:foo"; ":user_ns:start_page" is ":foo:start". The <b>common_ns</b> ' .
		 'is defined using the <code>common_ns</code> option.';
$lang['common_ns'] = 'An arbitrarily defined namespace of any depth where all auto login pages will reside.';		 
